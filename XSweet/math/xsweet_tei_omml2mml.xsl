...
<!-- A slight tweak on TEI's ooml2mml.xsl Beta Version 070708, to pass through both math and non-math elements alike. for use with Coko's XSweet docx-to-HTML pipeline -->
